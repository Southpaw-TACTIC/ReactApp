...
const ResponsiveAppBar = props => {
  ...
  }, modules.map((module, index) => React.createElement(MenuItem, {
    key: (module, index),
    onClick: e => {
      handleCloseNavMenu();
      set_tab_mode(module);
  ...
  }, modules.map((module, index) => React.createElement(Button, {
    key: index,
    onClick: e => {
      set_tab_mode(module);
      set_current(module);
  ...
  }, settings.map((setting, index) => React.createElement(MenuItem, {
    key: index,
    onClick: e => {
      handleCloseUserMenu();
    }
